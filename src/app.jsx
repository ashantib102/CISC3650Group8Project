  ...
  return (
    <header className="bc-header">
      <div className="logo-container">
        <img
          src="https://cdn.glitch.global/517fcbda-27d5-4a6f-a83b-4e7f1dd0ed2e/BCBitesLogoGemini.png?v=1745158374539"
          alt="BC BITES Logo"
          className="bc-logo"
        />
      </div>
      ...
      <nav className="bc-nav">
        ...
        <Link href="/food-trucks" className="nav-link">
          FOOD TRUCK INFO
        </Link>
      ...
      <div className="food-truck-list">
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            ...
            <p>
              Home of the award-winning Grandma Thin-Crust Sicilian Pie —
              proudly recognized as one of the best in New York!
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            ...
            <p>
              Whether you're craving jerk chicken or a braised oxtails meal,
              they've got your taste buds covered with their savory Caribbean
              dishes. (Lunch specials available).
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            <h3>Sammy's Halal ($)</h3>
            <p>
              Serving up street food favorites like chicken and lamb over rice,
              gyro wraps, and falafel, the award-winning Sammy's Halal recipient
              of a Vendy Award for best street food blends bold flavors with
              fresh ingredients to deliver a satisfying meal on the go.
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            ...
            <p>
              Serving authentic, freshly made tacos and pupusas with a variety
              of flavorful fillings that bring the vibrant tastes of Latin
              America street food to your plate!
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            ...
            <p>
              Offering a fresh selection of Glatt Kosher classics, from savory
              sandwiches to crispy eggrolls, bringing authentic flavors to
              campus.
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            <h3>Wafels & Dinges ($-$$)</h3>
            <p>
              Indulge in the sweet and savory delights of Wafels & Dinges.
              Whether you're in the mood for a crispy waffle or a scrumptious
              dinge, they've got you covered.
            </p>
          </div>
        </div>
        ...
        <div className="food-truck-item">
          ...
          <div className="food-truck-details">
            ...
            <p>
              We are your go-to for coffee on the move, serving up delicious,
              handcrafted coffee and espresso. Our truck is always ready to
              prepare fresh and bold flavors to keep you refreshed and
              energized.
            </p>
          </div>
        </div>
...
export function SchedulePage() {
  ...
  const randomizeTruckSchedules = () => {
    ...
    for (let i = truckSchedulesArray.length - 1; i > 0; i--) {
      ...
      [truckSchedulesArray[i], truckSchedulesArray[j]] = [
        truckSchedulesArray[j],
        truckSchedulesArray[i],
      ];
    }
  ...
  return (
    <div className="bc-bites-container">
      ...
      <div className="schedule-container">
        ...
        <div className="schedule-table" key={resetKey}>
    ...
    <div className="bc-bites-container">
      ...
      <div className="contact-container">
        <div className="contact-left">
          ...
          <p>
            E:{" "}
            <a href="mailto:bcfoodtruck@brooklyn.cuny.edu">
              bcfoodtruck@brooklyn.cuny.edu
            </a>{" "}
          </p>
          <p>
            P: <a href="tel:+17189515074">718.951.5074</a>{" "}
          </p>

          <div className="contact-image">
            <img
              className="schedule-image"
              src="https://cdn.glitch.global/517fcbda-27d5-4a6f-a83b-4e7f1dd0ed2e/directions-631x381%20(1).png?v=1745168515458"
              alt="Food Truck on Campus"
            />
          </div>
        </div>
        ...
        <div className="contact-right">
          <div className="vendor-contact">
            ...
            <p>
              E:{" "}
              <a href="mailto:basarvdogim@gmail.com">basarvdogim@gmail.com</a>
            </p>
            <p>
              P: <a href="tel:+17188748394">718.874.8394</a>{" "}
            </p>
          </div>
          ...
          <div className="vendor-contact">
            <h3>Sammy's Halal</h3>
            <p>
              E: <a href="mailto:sammyhalal@gmail.com">sammyhalal@gmail.com</a>{" "}
            </p>
            <p>
              P: <a href="tel:+17182743176">718.274.3176</a>
            </p>
          </div>
          ...
          <div className="vendor-contact">
            ...
            <p>
              E:{" "}
              <a href="mailto:lizbethstruck@gmail.com">
                lizbethstruck@gmail.com
              </a>
            </p>
            <p>
              P: <a href="tel:+16463935436">646.393.5436</a>
            </p>
          </div>
          ...
          <div className="vendor-contact">
            ...
            <p>
              E:{" "}
              <a href="mailto:bkjerktruck@gmail.com">bkjerktruck@gmail.com</a>
            </p>
            <p>
              P: <a href="tel:+17182456388">718.245.6388</a>
            </p>
          </div>
          ...
          <div className="vendor-contact">
            ...
            <p>
              E:{" "}
              <a href="mailto:jiannettopizza@outlook.com">
                jiannettopizza@outlook.com
              </a>
            </p>
            <p>
              P: <a href="tel:+17189519283">718.951.9283</a>
            </p>
          </div>
          ...
          <div className="vendor-contact">
            ...
            <p>
              E:{" "}
              <a href="mailto:wafels&dinges@gmail.com">
                wafels&dinges@gmail.com
              </a>
            </p>
            <p>
              P: <a href="tel:+17184768272">718.476.8272</a>
            </p>
          </div>
        </div>
      </div>
