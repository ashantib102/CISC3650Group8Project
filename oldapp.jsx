  ...
  return (
    <div className="bc-bites-container">
      ...
      <div className="food-truck-list">
        ...
        <div className="food-truck-item">
          <div className="food-truck-icon">
            <img src="https://cdn.glitch.global/517fcbda-27d5-4a6f-a83b-4e7f1dd0ed2e/download-removebg-preview%20(5).png?v=1745168496973" alt="Basarvdogim on Wheels" />
          </div>
          <div className="food-truck-details">
    ...
    <div className="bc-bites-container">
      ...
      <div className="contact-container">
        <div className="contact-left">
          ...
          <p>E: bcfoodtruck@brooklyn.cuny.edu</p>
          <p>P: 718.951.5074</p>
        ...
        <div className="contact-right">
          <div className="vendor-contact">
            <h3>Basarvdogim on Wheels</h3>
            <p>E: basarvdogimonwheels@gmail.com</p>
            <p>P: 718.874.8394</p>
          </div>
          
          <div className="vendor-contact">
            <h3>Sammy's Halal</h3>
            <p>E: sammyhalaltruck@gmail.com</p>
            <p>P: 718.274.3176</p>
          </div>
          
          <div className="vendor-contact">
            <h3>Tacos y Pupusas Lizbeth</h3>
            <p>E: lizbethstruck@gmail.com</p>
            <p>P: 646.393.5436</p>
          </div>
          
          <div className="vendor-contact">
            <h3>The BK Jerk Mobile</h3>
            <p>E: bkjerktruck@gmail.com</p>
            <p>P: 718.245.6388</p>
          </div>
          
          <div className="vendor-contact">
            <h3>Jiannetto's Pizza</h3>
            <p>E: jiannettopizza@outlook.com</p>
            <p>P: 718.951.9283</p>
          </div>
          
          <div className="vendor-contact">
            <h3>Wafels & Dinges</h3>
            <p>E: wafels&dinges@gmail.com</p>
            <p>P: 718.476.8272</p>
          </div>
        </div>
      </div>
